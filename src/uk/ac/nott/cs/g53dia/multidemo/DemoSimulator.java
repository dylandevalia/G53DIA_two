 ...
 * <p>
 * Creates a default {@link Environment}, a {@link DemoTanker} and a GUI window (a {@link
 * TankerViewer}) and executes the Tanker for DURATION days in the environment.
 *
...
public class DemoSimulator {
	...
	/**
	 * Time for which execution pauses so that GUI can update. Reducing this value causes the
