...
public interface CellFactory {
	...
	/**
	 * Generate a grid of cells for the environment. The grid should extend from the point given
	 * (x,y) to (x+size,y+size). The method Environment.createCell(Point,Cell) should be invoked to
	 * create the cells.
	 *
