...
/**
 * A default CellFactory which populates the environment with stations, wells and refuelling
 * points.
 *
 * @author Neil Madden
 */
...
public class DefaultCellFactory implements CellFactory {
	 ...
	 */
	final static double DEFAULT_FUELPUMP_DENSITY = 0.0003;
	
	Random r;
	
	/**
	 * Create a DefaultCellFactory with a specified random number generator This is mostly useful
