 ...
 * <p>
 * <p>Each tanker is required to return a single instance of an implementation of this interface at
 * each cycle (via the {@link Tanker#senseAndAct senseAndAct} method of the {@link Tanker} class).
 * This action contains the actual code to allow the Tanker to do work.</p>
 *
 * @author Neil Madden.
 */
/*
