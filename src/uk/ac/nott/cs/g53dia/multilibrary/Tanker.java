...
public abstract class Tanker {
	...
	/**
	 * The maximum amount of fuel a Tanker can have. Note: this is assumed to be an even number.
	 */
	 ...
	 */
	void useFuel(int a) throws ActionFailedException {
		if (fuelLevel <= 0) {
			throw new OutOfFuelException("Tanker: no fuel");
		}
		if (a <= 0) {
